...
public class MiscellaneousElements {
    List<Item_intials> Miscellaneouslist;

    public MiscellaneousElements() {

    }

    public List<Item_intials> getMiscellaneouslist() {
        List<Item_intials> initiaList=new ArrayList<>();
        initiaList.add(new Item_intials("MiscellaneousElement1",200,"/K.G."));
